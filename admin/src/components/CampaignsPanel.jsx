...
function CampaignsPanel({ token, tenantId, refreshKey, onNotify }) {
            ...
            {selectedCampaign && (
              <Stack spacing={2}>
                ...
                <Stack spacing={1.2}>
                  ...
                  <Button variant="outlined" onClick={() => saveWizardStep('audience')}>Save Audience</Button>
                </Stack>
                ...
                <Stack spacing={1.2}>
                  ...
                  <Button variant="outlined" onClick={() => saveWizardStep('content')}>Save Content</Button>
                </Stack>
                ...
                <Stack spacing={1.2}>
                  ...
                  <Stack direction="row" spacing={1}>
                    <Button variant="outlined" onClick={() => saveWizardStep('schedule')}>
                      Save Schedule
                    </Button>
                    <Button variant="contained" color="secondary" startIcon={<LaunchIcon />} onClick={launchCampaign}>
                      Launch
                    </Button>
                  </Stack>
                </Stack>
